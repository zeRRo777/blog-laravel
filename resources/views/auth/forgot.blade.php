...
<x-auth-head>Восстановление пароля</x-auth-head>
<body>
<div class="h-screen bg-white flex flex-col space-y-10 justify-center items-center">
    <div class="bg-white w-96 shadow-xl rounded p-5">
        ...
        <form class="space-y-5 mt-5" method="post" action="{{route('forgot_process')}}">
            @csrf
            <input name="email" type="text" class="w-full h-12 border border-blue-300 rounded px-3 @error('email') border-red-500 @enderror" placeholder="Email" />
            @error('email')
